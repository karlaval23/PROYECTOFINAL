<?php 
	...
	class Login extends Controllers{
		...
		{
			$data['page_tag'] = "Login - Glamour Secrets DJR";
			$data['page_title'] = "Glamour Secrets DJR";
		...
		public function loginUser() {
			...
			if ($_POST) {
				...
				if (!$allowAccessWithoutCredentials && (empty($_POST['txtEmail']) || empty($_POST['txtPassword']))) {
					...
					if ($allowAccessWithoutCredentials) {
						// Puedes establecer valores predeterminados o cualquier lógica necesaria aquí
						$_SESSION['idUser'] = 1; // ID de usuario predeterminado
						$_SESSION['login'] = true;
