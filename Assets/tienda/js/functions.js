...
//Seleccion de los metodos de pago
...
if (document.querySelector(".methodpago")) {
    ...
    optmetodo.forEach(function (optmetodo) {
        optmetodo.addEventListener('click', function () {
            // Inicializar todos los divs como ocultos
            ...
            document.querySelector("#divyape").classList.add("notblock");

            // Mostrar solo el div correspondiente al método seleccionado
            if (this.value == "Paypal") {
                document.querySelector("#divpaypal").classList.remove("notblock");
            } else if (this.value == "Yape") {
                document.querySelector("#divyape").classList.remove("notblock");
            } else if (this.value == "Culqi") {
                document.querySelector("#divculqi").classList.remove("notblock");
            } else { // Para 'CT' (Contra Entrega) u otros valores
