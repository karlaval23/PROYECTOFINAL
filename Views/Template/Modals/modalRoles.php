          ...
          <div class="tile">
            <div class="tile-body">
              <form id="formRol" name="formRol">
                ...
                <!-- Agregado el campo Observaciones -->
<div class="form-group">
  <label class="control-label">Observaciones</label>
  <textarea class="form-control" id="txtObservaciones" name="txtObservaciones" rows="2" placeholder="Observaciones del rol"></textarea>
</div>
