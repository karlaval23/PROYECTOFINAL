...
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="<?= media() ?>/tienda/images/beso.png"/>
<!--===============================================================================================-->
		...
		<div class="container-menu-desktop">
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<script>
						$(document).ready(function() {
						// Al hacer clic en un enlace dentro de .menu-desktop
						$('.menu-desktop .main-menu li a').on('click', function(event) {
							// Eliminar la clase activa de todos los elementos <li> dentro de .menu-desktop
							$('.menu-desktop .main-menu li').removeClass('active-menu');

							// Agregar la clase activa al <li> padre del enlace clicado
							$(this).parent().addClass('active-menu');
						});

						// Mantener la clase activa en la página actual
						...
						$('.menu-desktop .main-menu li a').each(function() {
							console.log("Comparing: " + this.href);
							if (this.href === currentUrl || (this.href === baseUrl && currentUrl === baseUrl + "/")) {
								console.log("Match found: " + this.href);
								$(this).parent().addClass('active-menu');
							}
						});
					});
